  ...
  return (
    <div className="relative bg-white pt-16">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Track Your Gaming</span>{' '}
                <span className="block text-primary xl:inline">Journey Like Never Before</span>
              </h1>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <div className="h-56 w-full bg-gradient-to-r from-primary to-secondary sm:h-72 md:h-96 lg:w-full lg:h-full"></div>
      </div>
    </div>
  );
} 