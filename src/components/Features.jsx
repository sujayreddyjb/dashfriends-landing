          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature) => (
              <div key={feature.name} className="relative group">
                <div className="absolute -inset-1 rounded-lg bg-gradient-to-r from-primary to-secondary opacity-0 group-hover:opacity-25 transition-opacity duration-200"></div>
                <div className="relative p-6 bg-white rounded-lg shadow-sm ring-1 ring-gray-900/5 transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
                  <div>
                    <span className="inline-flex p-3 rounded-lg bg-primary/10 text-primary ring-4 ring-primary/10">
                      {feature.icon}
                    </span>
                  </div>
